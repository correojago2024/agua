      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center p-4">
        <div className="max-w-md w-full bg-white rounded-2xl shadow-2xl overflow-hidden">
          <div className="bg-slate-900 p-6 text-center">
            ...
            <p className="text-slate-400 text-sm mt-2">Datos del Edificio</p>
          </div>
      ...
      <header className="border-b border-slate-700/50 backdrop-blur-sm bg-slate-900/50 sticky top-0 z-50">
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-slate-900 border-t border-slate-700 px-6 py-4 flex flex-col gap-4">
            <a href="#features" onClick={() => setMobileMenuOpen(false)} className="text-slate-300 hover:text-white py-2 border-b border-slate-800">Características</a>
            <a href="#acerca-de" onClick={() => setMobileMenuOpen(false)} className="text-slate-300 hover:text-white py-2 border-b border-slate-800">Acerca de</a>
            <a href="#contacto" onClick={() => setMobileMenuOpen(false)} className="text-slate-300 hover:text-white py-2 border-b border-slate-800">Contacto</a>
            ...
            <button onClick={() => { setView('register'); setMobileMenuOpen(false); }} className="border border-slate-600 text-slate-300 py-3 rounded-xl font-medium text-center">
              Registrar Edificio
            </button>
          </div>
        )}
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button
              ...
              className="border border-slate-600 text-slate-300 hover:bg-slate-800 font-semibold px-8 py-4 rounded-xl transition-all"
            >
              Registrar Edificio
            </button>
          </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6 items-stretch">
            ...
            <div className="bg-slate-800 border border-slate-700 rounded-2xl p-6 hover:border-blue-500/40 transition-all flex flex-col">
              ...
              <div className="bg-slate-700/50 rounded-xl p-3 text-xs text-slate-400 mb-4 font-mono">
            ...
            <div className="bg-slate-800 border border-slate-700 rounded-2xl p-6 hover:border-cyan-500/40 transition-all flex flex-col">
              ...
              <div className="flex-grow">
                <p className="text-slate-400 text-sm mb-4 leading-relaxed">
                  ...
                  <strong className="text-slate-300"> dashboard con gráficos en tiempo real</strong>, la gestión
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-slate-800/50 border border-slate-700/50 rounded-2xl p-8 hover:border-blue-500/30 transition-all">
              ...
              <p className="text-slate-400">Registro facil y rapido de niveles de agua a traves de formularios simples y accesibles desde cualquier dispositivo.</p>
            </div>
            ...
            <div className="bg-slate-800/50 border border-slate-700/50 rounded-2xl p-8 hover:border-blue-500/30 transition-all">
              ...
              <p className="text-slate-400">Graficos detallados y analisis del comportamiento del consumo de agua con 20 indicadores de inteligencia.</p>
            </div>
            ...
            <div className="bg-slate-800/50 border border-slate-700/50 rounded-2xl p-8 hover:border-blue-500/30 transition-all">
              ...
              <p className="text-slate-400">Recibe automaticamente reportes graficos con analisis detallado directamente en tu correo electronico.</p>
            </div>
      ...
      <section id="acerca-de" className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-slate-400 max-w-2xl mx-auto">Tecnología moderna al servicio de la eficiencia y transparencia en el manejo del agua en condominios.</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-slate-800/50 border border-slate-700/50 rounded-2xl p-8 hover:border-blue-500/30 transition-all">
              ...
              <p className="text-slate-400">Almacenamiento seguro y disponibilidad 24/7 de todos sus registros ingresados del nivel de agua.</p>
            </div>
            ...
            <div className="bg-slate-800/50 border border-slate-700/50 rounded-2xl p-8 hover:border-blue-500/30 transition-all">
              ...
              <p className="text-slate-400">Gráficos históricos, alertas de fugas y proyecciones en tiempo real.</p>
            </div>
            ...
            <div className="bg-slate-800/50 border border-slate-700/50 rounded-2xl p-8 hover:border-blue-500/30 transition-all">
              ...
              <p className="text-slate-400">Informes profesionales automáticos para copropietarios y junta de condominio.</p>
            </div>
            ...
            <div className="bg-slate-800/50 border border-slate-700/50 rounded-2xl p-8 hover:border-blue-500/30 transition-all">
              ...
              <p className="text-slate-400">Eliminación del error humano mediante ingeniería de datos automatizada.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="contacto" className="py-20 px-6 bg-slate-800/30">
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-slate-400">Déjanos tus datos y te contactaremos para una demostración personalizada.</p>
          </div>
